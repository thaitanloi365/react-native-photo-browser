...
const TOOLBAR_HEIGHT = Constants.TOOLBAR_HEIGHT + getStatusBarHeight(false);
    ...
    return (
      ...
      >
        ...
        <TopBarComponent
          ...
          backButtonImageStyle={backButtonImageStyle}
        />
      </View>
    );
  }
