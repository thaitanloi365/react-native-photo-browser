...
export default class BottomBar extends React.Component {
  ...
  _renderNavArrows() {
    ...
    if (displayNavArrows) {
      ...
      const leftArrow = (
        <TouchableOpacity key="left_arrow" style={styles.button} onPress={onPrev}>
          <Image source={require("../../Assets/arrow-left.png")} style={styles.buttonImage} />
        </TouchableOpacity>
      );
      const rightArrow = (
        <TouchableOpacity key="right_arrow" style={styles.button} onPress={onNext}>
          <Image source={require("../../Assets/arrow-right.png")} style={styles.buttonImage} />
        </TouchableOpacity>
      );
    ...
    if (displayGridButton) {
      return (
        <TouchableOpacity style={[styles.button, { flex: 0 }]} onPress={onGrid}>
          <Image source={require("../../Assets/grid-button.png")} style={styles.buttonImage} />
        </TouchableOpacity>
      );
    }
    return null;
    ...
    if (displayActionButton) {
      return (
        <TouchableOpacity style={[styles.button, { flex: 0 }]} onPress={onAction}>
          <Image source={require("../../Assets/share-button.png")} style={styles.buttonImage} />
        </TouchableOpacity>
      );
    }
    return null;
  ...
  render() {
    ...
    return (
      <BarContainer position={BAR_POSITIONS.BOTTOM} displayed={displayed} height={height} style={styles.container}>
